...
def start_backend():
    ...
    try:
        subprocess.run(["mvnw", "spring-boot:run"], cwd="./", check=True)
    except FileNotFoundError:
...
if __name__ == "__main__":
    print("Welcome to the AcmePlex Deployment Script!")
    ...
    backend_process = subprocess.Popen(["python", __file__, "start_backend"])
    start_frontend()

    print("[INFO] Both backend and frontend have been started successfully!")
